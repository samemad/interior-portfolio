 ...
 */var Ev;function zy(){if(Ev)return wo;Ev=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:s,type:r,key:f,ref:l!==void 0?l:null,props:c}}return wo.Fragment=e,wo.jsx=i,wo.jsxs=i,wo}var bv;function Hy(){return bv||(bv=1,td.exports=zy()),td.exports}var C=Hy(),nd={exports:{}},ft={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
#define LOW_PRECISION`),e}function YA(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===n_?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===yM?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===na&&(e="SHADOWMAP_TYPE_VSM"),e}function ZA(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ts:case As:e="ENVMAP_TYPE_CUBE";break;case Kc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function KA(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case As:e="ENVMAP_MODE_REFRACTION";break}return e}function QA(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case i_:e="ENVMAP_BLENDING_MULTIPLY";break;case zM:e="ENVMAP_BLENDING_MIX";break;case HM:e="ENVMAP_BLENDING_ADD";break}return e}function JA(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function $A(s,e,i,r){const l=s.getContext(),c=i.defines;let f=i.vertexShader,d=i.fragmentShader;const m=YA(i),p=ZA(i),g=KA(i),_=QA(i),x=JA(i),M=HA(i),T=GA(c),A=l.createProgram();let S,v,L=i.glslVersion?"#version "+i.glslVersion+`
...
}`;class Ee{constructor(y){this.props=y||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new o0,this.camera=new Xc,this.uniforms&&(this.material=new Cc(this.props.material),this.geometry=new Er(2,2),this.plane=new ui(this.geometry,this.material),this.scene.add(this.plane))}update(){pe.renderer.setRenderTarget(this.props.output||null),pe.renderer.render(this.scene,this.camera),pe.renderer.setRenderTarget(null)}}class Ke extends Ee{constructor(y){super({material:{vertexShader:W,fragmentShader:ne,uniforms:{boundarySpace:{value:y.cellScale},px:{value:y.cellScale},fboSize:{value:y.fboSize},velocity:{value:y.src.texture},dt:{value:y.dt},isBFECC:{value:!0}}},output:y.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){const y=new da,k=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);y.setAttribute("position",new Mi(k,3));const $=new Cc({vertexShader:Se,fragmentShader:ne,uniforms:this.uniforms});this.line=new zE(y,$),this.scene.add(this.line)}update({dt:y,isBounce:k,BFECC:$}){this.uniforms.dt.value=y,this.line.visible=k,this.uniforms.isBFECC.value=$,super.update()}}class qe extends Ee{constructor(y){super({output:y.dst}),this.init(y)}init(y){super.init();const k=new Er(1,1),$=new Cc({vertexShader:O,fragmentShader:Ue,blending:jd,depthWrite:!1,uniforms:{px:{value:y.cellScale},force:{value:new ct(0,0)},center:{value:new ct(0,0)},scale:{value:new ct(y.cursor_size,y.cursor_size)}}});this.mouse=new ui(k,$),this.scene.add(this.mouse)}update(y){const k=I.diff.x/2*y.mouse_force,$=I.diff.y/2*y.mouse_force,de=y.cursor_size*y.cellScale.x,re=y.cursor_size*y.cellScale.y,Ce=Math.min(Math.max(I.coords.x,-1+de+y.cellScale.x*2),1-de-y.cellScale.x*2),we=Math.min(Math.max(I.coords.y,-1+re+y.cellScale.y*2),1-re-y.cellScale.y*2),ze=this.mouse.material.uniforms;ze.force.value.set(k,$),ze.center.value.set(Ce,we),ze.scale.value.set(y.cursor_size,y.cursor_size),super.update()}}class ut extends Ee{constructor(y){super({material:{vertexShader:W,fragmentShader:ve,uniforms:{boundarySpace:{value:y.boundarySpace},velocity:{value:y.src.texture},velocity_new:{value:y.dst_.texture},v:{value:y.viscous},px:{value:y.cellScale},dt:{value:y.dt}}},output:y.dst,output0:y.dst_,output1:y.dst}),this.init()}update({viscous:y,iterations:k,dt:$}){let de,re;this.uniforms.v.value=y;for(let Ce=0;Ce<k;Ce++)Ce%2===0?(de=this.props.output0,re=this.props.output1):(de=this.props.output1,re=this.props.output0),this.uniforms.velocity_new.value=de.texture,this.props.output=re,this.uniforms.dt.value=$,super.update();return re}}class Zt extends Ee{constructor(y){super({material:{vertexShader:W,fragmentShader:Me,uniforms:{boundarySpace:{value:y.boundarySpace},velocity:{value:y.src.texture},px:{value:y.cellScale},dt:{value:y.dt}}},output:y.dst}),this.init()}update({vel:y}){this.uniforms.velocity.value=y.texture,super.update()}}class H extends Ee{constructor(y){super({material:{vertexShader:W,fragmentShader:Ge,uniforms:{boundarySpace:{value:y.boundarySpace},pressure:{value:y.dst_.texture},divergence:{value:y.src.texture},px:{value:y.cellScale}}},output:y.dst,output0:y.dst_,output1:y.dst}),this.init()}update({iterations:y}){let k,$;for(let de=0;de<y;de++)de%2===0?(k=this.props.output0,$=this.props.output1):(k=this.props.output1,$=this.props.output0),this.uniforms.pressure.value=k.texture,this.props.output=$,super.update();return $}}class Dt extends Ee{constructor(y){super({material:{vertexShader:W,fragmentShader:ae,uniforms:{boundarySpace:{value:y.boundarySpace},pressure:{value:y.src_p.texture},velocity:{value:y.src_v.texture},px:{value:y.cellScale},dt:{value:y.dt}}},output:y.dst}),this.init()}update({vel:y,pressure:k}){this.uniforms.velocity.value=y.texture,this.uniforms.pressure.value=k.texture,super.update()}}class st{constructor(y){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...y},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new ct,this.cellScale=new ct,this.boundarySpace=new ct,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?Ns:Ui}createAllFBO(){const k={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:Gn,magFilter:Gn,wrapS:Si,wrapT:Si};for(let $ in this.fbos)this.fbos[$]=new qa(this.fboSize.x,this.fboSize.y,k)}createShaderPass(){this.advection=new Ke({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new qe({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new ut({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new Zt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new H({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new Dt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){const y=Math.max(1,Math.round(this.options.resolution*pe.width)),k=Math.max(1,Math.round(this.options.resolution*pe.height)),$=1/y,de=1/k;this.cellScale.set($,de),this.fboSize.set(y,k)}resize(){this.calcSize();for(let y in this.fbos)this.fbos[y].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let y=this.fbos.vel_1;this.options.isViscous&&(y=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:y});const k=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:y,pressure:k})}}class et{constructor(){this.init()}init(){this.simulation=new st,this.scene=new o0,this.camera=new Xc,this.output=new ui(new Er(2,2),new Cc({vertexShader:W,fragmentShader:ye,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new ct},palette:{value:B},bgColor:{value:Y}}})),this.scene.add(this.output)}addScene(y){this.scene.add(y)}resize(){this.simulation.resize()}render(){pe.renderer.setRenderTarget(null),pe.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class Ie{constructor(y){this.props=y,pe.init(y.$wrapper),I.init(y.$wrapper),I.autoIntensity=y.autoIntensity,I.takeoverDuration=y.takeoverDuration,this.lastUserInteraction=performance.now(),I.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new Q(I,this,{enabled:y.autoDemo,speed:y.autoSpeed,resumeDelay:y.autoResumeDelay,rampDuration:y.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener("resize",this._resize),this._onVisibility=()=>{document.hidden?this.pause():K.current&&this.start()},document.addEventListener("visibilitychange",this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(pe.renderer.domElement),this.output=new et}resize(){pe.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),I.update(),pe.update(),this.output.update()}loop(){this.running&&(this.render(),V.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,V.current&&(cancelAnimationFrame(V.current),V.current=null)}dispose(){try{if(window.removeEventListener("resize",this._resize),document.removeEventListener("visibilitychange",this._onVisibility),I.dispose(),pe.renderer){const y=pe.renderer.domElement;y&&y.parentNode&&y.parentNode.removeChild(y),pe.renderer.dispose()}}catch{}}}const Mt=P.current;Mt.style.position=Mt.style.position||"relative",Mt.style.overflow=Mt.style.overflow||"hidden";const Ve=new Ie({$wrapper:Mt,autoDemo:M,autoSpeed:T,autoIntensity:A,takeoverDuration:S,autoResumeDelay:v,autoRampDuration:L});N.current=Ve,(()=>{if(!N.current)return;const U=N.current.output?.simulation;if(!U)return;const y=U.options.resolution;Object.assign(U.options,{mouse_force:s,cursor_size:e,isViscous:i,viscous:r,iterations_viscous:l,iterations_poisson:c,dt:f,BFECC:d,resolution:m,isBounce:p}),m!==y&&U.resize()})(),Ve.start();const Gt=new IntersectionObserver(U=>{const y=U[0],k=y.isIntersecting&&y.intersectionRatio>0;K.current=k,N.current&&(k&&!document.hidden?N.current.start():N.current.pause())},{threshold:[0,.01,.1]});Gt.observe(Mt),G.current=Gt;const Vt=new ResizeObserver(()=>{N.current&&(D.current&&cancelAnimationFrame(D.current),D.current=requestAnimationFrame(()=>{N.current&&N.current.resize()}))});return Vt.observe(Mt),F.current=Vt,()=>{if(V.current&&cancelAnimationFrame(V.current),F.current)try{F.current.disconnect()}catch{}if(G.current)try{G.current.disconnect()}catch{}N.current&&N.current.dispose(),N.current=null}},[d,e,f,p,i,c,l,s,m,r,g,M,T,A,S,v,L]),te.useEffect(()=>{const b=N.current;if(!b)return;const B=b.output?.simulation;if(!B)return;const Y=B.options.resolution;Object.assign(B.options,{mouse_force:s,cursor_size:e,isViscous:i,viscous:r,iterations_viscous:l,iterations_poisson:c,dt:f,BFECC:d,resolution:m,isBounce:p}),b.autoDriver&&(b.autoDriver.enabled=M,b.autoDriver.speed=T,b.autoDriver.resumeDelay=v,b.autoDriver.rampDurationMs=L*1e3,b.autoDriver.mouse&&(b.autoDriver.mouse.autoIntensity=A,b.autoDriver.mouse.takeoverDuration=S)),m!==Y&&B.resize()},[s,e,i,r,l,c,f,d,m,p,M,T,A,S,v,L]),C.jsx("div",{ref:P,className:`liquid-ether-container ${x||""}`,style:{width:"100%",height:"100%",background:"linear-gradient(45deg, #1a1a2e, #16213e)",borderRadius:"12px",overflow:"hidden",..._}})}function CR(){const[s,e]=te.useState(!1),[i,r]=te.useState(!1),l=c=>{c.preventDefault();const f=document.getElementById("about");f&&f.scrollIntoView({behavior:"smooth"})};return te.useEffect(()=>{const c=setTimeout(()=>{e(!0),setTimeout(()=>r(!0),300)},800);return()=>clearTimeout(c)},[]),C.jsxs("section",{className:"relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950",children:[C.jsx("div",{className:"absolute inset-0",children:C.jsx(wR,{colors:["#5227FF","#FF9FFC","#B19EEF"],mouseForce:15,cursorSize:120,autoDemo:!0,autoSpeed:.3,autoIntensity:1.5,resolution:.4})}),C.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-black/70"}),C.jsx("div",{className:"absolute inset-0 bg-gradient-radial from-transparent via-black/10 to-black/30"}),C.jsx("div",{className:"relative z-10 w-full max-w-6xl mx-auto px-4 lg:px-8",children:C.jsxs("div",{className:"grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-screen py-16",children:[C.jsxs("div",{className:`space-y-6 transition-all duration-1500 delay-300 ${i?"opacity-100 translate-x-0":"opacity-0 -translate-x-12"}`,children:[C.jsxs("div",{className:"space-y-4",children:[C.jsxs("div",{className:"flex items-center space-x-3 mb-3",children:[C.jsx("div",{className:"w-12 h-px bg-gradient-to-r from-purple-400 to-transparent"}),C.jsx("span",{className:"text-purple-300 text-xs font-light tracking-[0.2em] uppercase",children:"Award Winning Design"})]}),C.jsxs("h1",{className:"space-y-1",children:[C.jsx("div",{className:"text-3xl md:text-4xl xl:text-5xl font-light text-white tracking-tight leading-none",children:"Luxury"}),C.jsx("div",{className:"text-3xl md:text-4xl xl:text-5xl font-extralight text-transparent bg-gradient-to-r from-purple-300 via-pink-300 to-purple-400 bg-clip-text tracking-tight leading-none",children:"Interior Design"})]}),C.jsxs("div",{className:"max-w-md",children:[C.jsx("p",{className:"text-gray-300 text-base leading-relaxed font-light mb-4",children:"Crafting bespoke environments where every detail tells a story of elegance, functionality, and timeless sophistication."}),C.jsxs("div",{className:"flex items-center space-x-4 text-xs text-purple-200",children:[C.jsxs("span",{className:"flex items-center",children:[C.jsx("div",{className:"w-1.5 h-1.5 bg-purple-400 rounded-full mr-2"}),"Offices"]}),C.jsxs("span",{className:"flex items-center",children:[C.jsx("div",{className:"w-1.5 h-1.5 bg-pink-400 rounded-full mr-2"}),"Residences"]}),C.jsxs("span",{className:"flex items-center",children:[C.jsx("div",{className:"w-1.5 h-1.5 bg-purple-300 rounded-full mr-2"}),"Hospitality"]})]})]})]}),C.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 pt-3",children:[C.jsxs(Ds,{to:"/projects",className:"group relative px-6 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-sm hover:bg-white/20 transition-all duration-500 overflow-hidden",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-purple-600/20 to-pink-600/20 translate-x-full group-hover:translate-x-0 transition-transform duration-500"}),C.jsx("span",{className:"relative text-white font-light tracking-wide text-xs uppercase",children:"View Projects"}),C.jsx("div",{className:"absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700"})]}),C.jsx("a",{href:"#about",onClick:l,className:"group px-6 py-3 border border-purple-300/30 rounded-sm hover:border-purple-300/60 transition-all duration-500 backdrop-blur-sm",children:C.jsx("span",{className:"text-purple-200 group-hover:text-white font-light tracking-wide text-xs uppercase transition-colors duration-300",children:"About Me"})})]})]}),C.jsx("div",{className:`flex items-center justify-center transition-all duration-1500 delay-700 ${i?"opacity-100 translate-x-0":"opacity-0 translate-x-12"}`,children:C.jsx("div",{className:"relative",children:C.jsxs("div",{className:"w-56 h-64 sm:w-60 sm:h-68 lg:w-64 lg:h-72 border border-purple-300/20 rounded-sm relative",children:[C.jsx("div",{className:"absolute -top-2 -left-2 sm:-top-3 sm:-left-3 w-5 h-5 sm:w-6 sm:h-6 border-l-2 border-t-2 border-purple-400"}),C.jsx("div",{className:"absolute -top-2 -right-2 sm:-top-3 sm:-right-3 w-5 h-5 sm:w-6 sm:h-6 border-r-2 border-t-2 border-pink-400"}),C.jsx("div",{className:"absolute -bottom-2 -left-2 sm:-bottom-3 sm:-left-3 w-5 h-5 sm:w-6 sm:h-6 border-l-2 border-b-2 border-pink-400"}),C.jsx("div",{className:"absolute -bottom-2 -right-2 sm:-bottom-3 sm:-right-3 w-5 h-5 sm:w-6 sm:h-6 border-r-2 border-b-2 border-purple-400"}),C.jsx("div",{className:"absolute inset-3 sm:inset-4 bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-sm flex items-center justify-center",children:C.jsxs("div",{className:"text-center space-y-2 sm:space-y-3",children:[C.jsx("div",{className:"text-3xl sm:text-4xl lg:text-5xl font-extralight text-purple-200",children:"6+"}),C.jsx("div",{className:"text-xs text-gray-300 tracking-[0.15em] uppercase",children:"Years of Experience"}),C.jsx("div",{className:"w-10 sm:w-12 h-px bg-gradient-to-r from-purple-400 to-pink-400 mx-auto"}),C.jsx("div",{className:"text-xs text-gray-400",children:"Crafting luxury spaces"})]})})]})})})]})}),!s&&C.jsx("div",{className:"absolute inset-0 bg-slate-950 flex items-center justify-center",children:C.jsxs("div",{className:"text-center space-y-6",children:[C.jsxs("div",{className:"relative w-20 h-20 mx-auto",children:[C.jsx("div",{className:"absolute inset-0 border-2 border-purple-300/20 rounded-full"}),C.jsx("div",{className:"absolute inset-0 border-2 border-purple-400 rounded-full border-t-transparent animate-spin"})]}),C.jsxs("div",{className:"space-y-2",children:[C.jsx("div",{className:"text-purple-200 text-xs font-light tracking-[0.2em] uppercase",children:"Loading Experience"}),C.jsxs("div",{className:"flex justify-center space-x-1",children:[C.jsx("div",{className:"w-1 h-1 bg-purple-400 rounded-full animate-pulse",style:{animationDelay:"0ms"}}),C.jsx("div",{className:"w-1 h-1 bg-pink-400 rounded-full animate-pulse",style:{animationDelay:"200ms"}}),C.jsx("div",{className:"w-1 h-1 bg-purple-300 rounded-full animate-pulse",style:{animationDelay:"400ms"}})]})]})]})}),i&&C.jsx("div",{className:"absolute bottom-6 left-1/2 transform -translate-x-1/2 animate-bounce",children:C.jsx("div",{className:"w-5 h-8 border-2 border-purple-300/40 rounded-full flex justify-center",children:C.jsx("div",{className:"w-0.5 h-2 bg-gradient-to-b from-purple-400 to-transparent rounded-full mt-1.5 animate-pulse"})})})]})}var Oh=new Map,Lc=new WeakMap,I0=0,DR=void 0;function NR(s){return s?(Lc.has(s)||(I0+=1,Lc.set(s,I0.toString())),Lc.get(s)):"0"}function UR(s){return Object.keys(s).sort().filter(e=>s[e]!==void 0).map(e=>`${e}_${e==="root"?NR(s.root):s[e]}`).toString()}function LR(s){const e=UR(s);let i=Oh.get(e);if(!i){const r=new Map;let l;const c=new IntersectionObserver(f=>{f.forEach(d=>{var m;const p=d.isIntersecting&&l.some(g=>d.intersectionRatio>=g);s.trackVisibility&&typeof d.isVisible>"u"&&(d.isVisible=p),(m=r.get(d.target))==null||m.forEach(g=>{g(p,d)})})},s);l=c.thresholds||(Array.isArray(s.threshold)?s.threshold:[s.threshold||0]),i={id:e,observer:c,elements:r},Oh.set(e,i)}return i}function OR(s,e,i={},r=DR){if(typeof window.IntersectionObserver>"u"&&r!==void 0){const m=s.getBoundingClientRect();return e(r,{isIntersecting:r,target:s,intersectionRatio:typeof i.threshold=="number"?i.threshold:0,time:0,boundingClientRect:m,intersectionRect:m,rootBounds:m}),()=>{}}const{id:l,observer:c,elements:f}=LR(i),d=f.get(s)||[];return f.has(s)||f.set(s,d),d.push(e),c.observe(s),function(){d.splice(d.indexOf(e),1),d.length===0&&(f.delete(s),c.unobserve(s)),f.size===0&&(c.disconnect(),Oh.delete(l))}}function U_({threshold:s,delay:e,trackVisibility:i,rootMargin:r,root:l,triggerOnce:c,skip:f,initialInView:d,fallbackInView:m,onChange:p}={}){var g;const[_,x]=te.useState(null),M=te.useRef(p),[T,A]=te.useState({inView:!!d,entry:void 0});M.current=p,te.useEffect(()=>{if(f||!_)return;let P;return P=OR(_,(N,F)=>{A({inView:N,entry:F}),M.current&&M.current(N,F),F.isIntersecting&&c&&P&&(P(),P=void 0)},{root:l,rootMargin:r,threshold:s,trackVisibility:i,delay:e},m),()=>{P&&P()}},[Array.isArray(s)?s.toString():s,_,l,r,c,f,i,m,e]);const S=(g=T.entry)==null?void 0:g.target,v=te.useRef(void 0);!_&&S&&!c&&!f&&v.current!==S&&(v.current=S,A({inView:!!d,entry:void 0}));const L=[x,T.inView,T.entry];return L.ref=L[0],L.inView=L[1],L.entry=L[2],L}const PR=({item:s})=>{const{ref:e,inView:i}=U_({triggerOnce:!0,threshold:.2}),r=l=>l?l.startsWith("http")?l:`https://interior-portfolio-api.onrender.com${l}`:null;return C.jsxs(Ds,{to:`/category/${s.id}`,ref:e,className:`min-w-[400px] md:min-w-[450px] lg:min-w-[500px] group relative rounded-2xl overflow-hidden border border-white/5 flex-shrink-0 transition-transform duration-700 ease-out
        ${i?"opacity-100 translate-y-0":"opacity-0 translate-y-10"}
        hover:scale-105 hover:shadow-2xl`,children:[C.jsx("div",{className:"aspect-[16/10] bg-center bg-cover group-hover:scale-110 transition-transform duration-500",style:{backgroundImage:`url(${s.cover_image?r(s.cover_image):"/placeholder.jpg"})`}}),C.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"}),C.jsx("div",{className:"absolute bottom-4 left-4",children:C.jsx("h3",{className:"text-base md:text-lg font-medium group-hover:text-luxuryGold transition-colors duration-300",children:s.name})})]})},L_="https://interior-portfolio-api.onrender.com/api",O_=async(s,e={},i=6e4)=>{const r=new AbortController,l=setTimeout(()=>r.abort(),i);try{const c=await fetch(s,{...e,signal:r.signal});return clearTimeout(l),c}catch(c){throw clearTimeout(l),c.name==="AbortError"?new Error(`Request timed out after ${i/1e3} seconds`):c}},P_=async(s,e)=>{if(!s.ok){const i=await s.text();throw console.error(`${e} failed:`,s.status,i),new Error(`${e} failed: ${s.status} ${s.statusText}`)}return s.json()};async function BR(){console.log("🔄 Fetching categories...");const s=Date.now();try{const e=await O_(`${L_}/categories`,{},3e4),i=await P_(e,"Fetch categories"),r=Date.now()-s;return console.log(`✅ Categories fetched in ${r}ms`),i}catch(e){const i=Date.now()-s;throw console.error(`❌ Failed to fetch categories after ${i}ms:`,e.message),e}}async function IR(){console.log("🔄 Fetching all projects...");const s=Date.now();try{const e=await O_(`${L_}/projects`,{},15e3),i=await P_(e,"Fetch all projects"),r=Date.now()-s;return console.log(`✅ All projects fetched in ${r}ms. Found: ${i.length} projects`),i}catch(e){const i=Date.now()-s;throw console.error(`❌ Failed to fetch all projects after ${i}ms:`,e.message),e}}function FR(){const[s,e]=te.useState([]),[i,r]=te.useState(!0),[l,c]=te.useState(null),[f,d]=te.useState(!1),m=fa();return te.useEffect(()=>{if(!m.state?.scrollTo)return;const p=m.state.scrollTo;((_,x=1e3)=>{const M=Date.now(),T=()=>{const A=document.getElementById(_);if(A){const v=A.getBoundingClientRect().top+window.pageYOffset+-64;window.scrollTo({top:v,behavior:"smooth"}),window.history.replaceState({},document.title,window.location.pathname);return}if(Date.now()-M<x)requestAnimationFrame(T);else{const S=document.getElementById(_);if(S){const L=S.getBoundingClientRect().top+window.pageYOffset+-64;window.scrollTo({top:L,behavior:"smooth"})}window.history.replaceState({},document.title,window.location.pathname)}};T()})(p,1200)},[m]),te.useEffect(()=>{(async()=>{try{const p=await BR();e(p)}catch(p){c(p.message||"Failed to load categories")}finally{r(!1)}})()},[]),C.jsxs("div",{className:"bg-slate-950 min-h-screen",children:[C.jsx(CR,{}),C.jsxs("section",{id:"categories",className:"relative py-20",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"}),C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-purple-900/5 via-transparent to-pink-900/5"}),C.jsxs("div",{className:"relative max-w-6xl mx-auto px-4",children:[C.jsxs("div",{className:"text-center mb-12",children:[C.jsxs("div",{className:"flex items-center justify-center space-x-4 mb-4",children:[C.jsx("div",{className:"w-12 h-px bg-gradient-to-r from-purple-400 to-transparent"}),C.jsx("span",{className:"text-purple-300 text-xs font-light tracking-[0.2em] uppercase",children:"Our Services"}),C.jsx("div",{className:"w-12 h-px bg-gradient-to-l from-pink-400 to-transparent"})]}),C.jsxs("h2",{className:"text-3xl md:text-4xl font-light text-white tracking-tight",children:["Design ",C.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text font-extralight",children:"Categories"})]})]}),i&&C.jsx("div",{className:"flex justify-center items-center py-12",children:C.jsxs("div",{className:"relative w-16 h-16",children:[C.jsx("div",{className:"absolute inset-0 border-2 border-purple-300/20 rounded-full"}),C.jsx("div",{className:"absolute inset-0 border-2 border-purple-400 rounded-full border-t-transparent animate-spin"})]})}),l&&C.jsx("div",{className:"text-center py-8",children:C.jsx("p",{className:"text-red-400 bg-red-900/20 backdrop-blur-sm border border-red-500/20 rounded-lg px-4 py-2 inline-block",children:l})}),C.jsx("div",{className:"flex gap-6 overflow-x-auto py-4 px-2 scrollbar-hide touch-pan-x",style:{overflowY:"hidden",WebkitOverflowScrolling:"touch"},onTouchStart:p=>{p.currentTarget.touchStartY=p.touches[0].clientY},onTouchMove:p=>{const g=p.touches[0].clientY,_=p.currentTarget.touchStartY,x=Math.abs(g-_);Math.abs(p.touches[0].clientX-(p.currentTarget.touchStartX||p.touches[0].clientX))>x&&p.preventDefault()},children:s.map(p=>C.jsx(PR,{item:p},p.id))})]})]}),C.jsxs("section",{id:"about",className:"relative py-20",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900"}),C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-purple-900/10 to-transparent"}),C.jsx("div",{className:"relative max-w-6xl mx-auto px-4",children:C.jsxs("div",{className:"grid md:grid-cols-2 gap-12 lg:gap-16 items-center",children:[C.jsxs("div",{className:"relative group",children:[C.jsx("div",{className:"absolute -inset-1 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-1000"}),C.jsxs("div",{className:"relative rounded-2xl overflow-hidden border border-purple-300/20 backdrop-blur-sm min-h-[300px]",children:[!f&&C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-slate-800 via-purple-900/20 to-slate-800 animate-pulse rounded-2xl",children:C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-transparent via-purple-400/20 to-transparent animate-pulse",style:{animation:"shimmer 2s infinite"}})}),C.jsx("img",{src:"/interior-portfolio/hero-bg.png",alt:"About Me",className:`mx-auto rounded-2xl object-cover transition-opacity duration-700 ${f?"opacity-100":"opacity-0"}`,style:{maxHeight:"400px",width:"100%",objectFit:"cover"},loading:"eager",onLoad:()=>d(!0),onError:()=>{console.log("Image failed to load"),d(!0)}}),C.jsx("div",{className:"absolute -top-2 -left-2 w-6 h-6 border-l-2 border-t-2 border-purple-400"}),C.jsx("div",{className:"absolute -top-2 -right-2 w-6 h-6 border-r-2 border-t-2 border-pink-400"}),C.jsx("div",{className:"absolute -bottom-2 -left-2 w-6 h-6 border-l-2 border-b-2 border-pink-400"}),C.jsx("div",{className:"absolute -bottom-2 -right-2 w-6 h-6 border-r-2 border-b-2 border-purple-400"})]})]}),C.jsxs("div",{className:"space-y-6",children:[C.jsxs("div",{className:"flex items-center space-x-3 mb-4",children:[C.jsx("div",{className:"w-12 h-px bg-gradient-to-r from-purple-400 to-transparent"}),C.jsx("span",{className:"text-purple-300 text-xs font-light tracking-[0.2em] uppercase",children:"About Designer"})]}),C.jsxs("h2",{className:"text-3xl md:text-4xl font-light text-white tracking-tight",children:["About ",C.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text font-extralight",children:"Me"})]}),C.jsx("p",{className:"text-gray-300 text-lg leading-relaxed font-light",children:"I'm a luxury interior designer focused on creating functional, warm, and timeless spaces. My process blends meticulous planning with material sensitivity to achieve designs that age beautifully."}),C.jsxs("a",{href:"#contact",onClick:p=>{p.preventDefault(),document.getElementById("contact")?.scrollIntoView({behavior:"smooth"})},className:"group inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-sm text-white font-light tracking-wide text-sm uppercase hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-500",children:["Get in touch",C.jsx("svg",{className:"ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform duration-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:C.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})]})]})})]}),C.jsxs("section",{id:"contact",className:"relative py-20",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"}),C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-purple-900/10 via-transparent to-pink-900/10"}),C.jsxs("div",{className:"relative max-w-6xl mx-auto px-4",children:[C.jsxs("div",{className:"text-center mb-12",children:[C.jsxs("div",{className:"flex items-center justify-center space-x-4 mb-4",children:[C.jsx("div",{className:"w-12 h-px bg-gradient-to-r from-purple-400 to-transparent"}),C.jsx("span",{className:"text-purple-300 text-xs font-light tracking-[0.2em] uppercase",children:"Get In Touch"}),C.jsx("div",{className:"w-12 h-px bg-gradient-to-l from-pink-400 to-transparent"})]}),C.jsxs("h2",{className:"text-3xl md:text-4xl font-light text-white tracking-tight",children:["Let's ",C.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text font-extralight",children:"Connect"})]})]}),C.jsxs("div",{className:"relative group max-w-4xl mx-auto",children:[C.jsx("div",{className:"absolute -inset-1 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-1000"}),C.jsx("div",{className:"relative rounded-2xl p-8 lg:p-12 bg-slate-900/80 backdrop-blur-lg border border-purple-300/20",children:C.jsxs("div",{className:"flex flex-col lg:flex-row items-center lg:justify-between gap-8",children:[C.jsxs("div",{className:"text-center lg:text-left space-y-4",children:[C.jsx("h3",{className:"text-2xl font-light text-white mb-6",children:"Contact Information"}),C.jsxs("div",{className:"space-y-3",children:[C.jsxs("div",{className:"flex items-center justify-center lg:justify-start space-x-3",children:[C.jsx("div",{className:"w-2 h-2 bg-purple-400 rounded-full"}),C.jsx("span",{className:"text-gray-300",children:"Email:"}),C.jsx("a",{href:"mailto:shaimaaemad2020@gmail.com",className:"text-purple-300 hover:text-pink-300 transition-colors duration-300",children:"shaimaaemad2020@gmail.com"})]}),C.jsxs("div",{className:"flex items-center justify-center lg:justify-start space-x-3",children:[C.jsx("div",{className:"w-2 h-2 bg-pink-400 rounded-full"}),C.jsx("span",{className:"text-gray-300",children:"Instagram:"}),C.jsx("a",{href:"https://www.instagram.com/shaimaa_alathwary",target:"_blank",rel:"noopener noreferrer",className:"text-purple-300 hover:text-pink-300 transition-colors duration-300",children:"@Shaimaa Al-athwary"})]})]})]}),C.jsxs("div",{className:"flex items-center gap-6",children:[C.jsxs("a",{href:"https://www.facebook.com/Shaimaa Al-athwary",target:"_blank",rel:"noopener noreferrer",className:"group relative p-4 bg-white/5 backdrop-blur-sm border border-purple-300/20 rounded-full hover:bg-white/10 hover:border-purple-300/40 transition-all duration-500",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"}),C.jsx("i",{className:"fab fa-facebook-f text-xl text-purple-300 group-hover:text-white relative z-10 transition-colors duration-300"})]}),C.jsxs("a",{href:"https://www.instagram.com/shaimaa_alathwary",target:"_blank",rel:"noopener noreferrer",className:"group relative p-4 bg-white/5 backdrop-blur-sm border border-purple-300/20 rounded-full hover:bg-white/10 hover:border-purple-300/40 transition-all duration-500",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"}),C.jsx("i",{className:"fab fa-instagram text-xl text-purple-300 group-hover:text-white relative z-10 transition-colors duration-300"})]}),C.jsxs("a",{href:"https://www.linkedin.com",target:"_blank",rel:"noopener noreferrer",className:"group relative p-4 bg-white/5 backdrop-blur-sm border border-purple-300/20 rounded-full hover:bg-white/10 hover:border-purple-300/40 transition-all duration-500",children:[C.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"}),C.jsx("i",{className:"fab fa-linkedin-in text-xl text-purple-300 group-hover:text-white relative z-10 transition-colors duration-300"})]})]})]})})]})]})]})]})}function zR(){const{categoryId:s}=Y0(),[e,i]=te.useState(null),[r,l]=te.useState([]),[c,f]=te.useState(!0);return te.useEffect(()=>{async function d(){try{const m=await fetch(`https://interior-portfolio-api.onrender.com/api/categories/${s}`),p=await fetch(`https://interior-portfolio-api.onrender.com/api/projects/category/${s}`),g=await m.json(),_=await p.json();i(g),l(_)}catch(m){console.error("Error fetching category data:",m)}finally{f(!1)}}d()},[s]),c?C.jsx("p",{className:"text-center py-10",children:"Loading..."}):e?C.jsxs("section",{className:"max-w-6xl mx-auto px-4 pt-10",children:[C.jsx("h1",{className:"text-3xl font-bold mb-6",children:e.name}),r.length===0?C.jsx("p",{className:"text-white/60",children:"No projects found under this category."}):C.jsx("div",{className:"grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3",children:r.map(d=>C.jsx(Ds,{to:`/projects/${d.id}`,children:C.jsxs("div",{className:"rounded-2xl overflow-hidden border border-white/10 bg-white/5 hover:scale-105 transition",children:[d.images?.[0]&&C.jsx("img",{src:d.images[0].path,alt:d.title,className:"w-full h-48 object-cover"}),C.jsxs("div",{className:"p-4",children:[C.jsx("h3",{className:"font-medium",children:d.title}),C.jsx("p",{className:"text-sm text-white/60 line-clamp-2",children:d.description})]})]})},d.id))})]}):C.jsx("p",{className:"text-center py-10",children:"Category not found."})}function HR({project:s}){const{ref:e,inView:i}=U_({triggerOnce:!0,threshold:.2});return C.jsxs(Ds,{to:`/projects/${s.id}`,ref:e,className:`rounded-2xl overflow-hidden border border-white/10 bg-white/5 p-4 transition-transform duration-700 ease-out
        ${i?"opacity-100 translate-y-0":"opacity-0 translate-y-10"}
        hover:scale-105 hover:shadow-2xl`,children:[s.images?.[0]&&C.jsx("img",{src:s.images[0].path,alt:s.title,className:"w-full h-48 object-cover rounded-2xl mb-4"}),C.jsxs("div",{children:[C.jsx("div",{className:"text-xs text-white/60",children:s.category}),C.jsx("h3",{className:"font-medium mt-1",children:s.title}),C.jsx("p",{className:"text-sm text-white/60 mt-1 line-clamp-3",children:s.description})]})]})}function GR(){const[s,e]=te.useState([]),[i,r]=te.useState(!0),[l,c]=te.useState(null);return te.useEffect(()=>{(async()=>{try{const f=await IR();e(Array.isArray(f)?f:[])}catch(f){console.error(f),c(f.message||"Failed to load projects")}finally{r(!1)}})()},[]),i?C.jsx("p",{className:"text-white/70 py-10",children:"Loading projects…"}):l?C.jsx("p",{className:"text-red-400 py-10",children:l}):s.length?C.jsxs("section",{className:"max-w-6xl mx-auto px-4 pt-10",children:[C.jsx("h1",{className:"font-display text-3xl mb-6",children:"Projects"}),C.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:s.map(f=>C.jsx(HR,{project:f},f.id))})]}):C.jsx("p",{className:"text-white/60 py-10",children:"No projects found."})}function VR(){const{id:s}=Y0(),[e,i]=te.useState(null),[r,l]=te.useState(!0),[c,f]=te.useState(null),[d,m]=te.useState(!1),[p,g]=te.useState(0);te.useEffect(()=>{(async()=>{try{const A=await fetch(`https://interior-portfolio-api.onrender.com/api/projects/${s}`);if(!A.ok)throw new Error("Failed to fetch project");const S=await A.json();i(S)}catch(A){console.error(A),f(A.message||"Failed to load project")}finally{l(!1)}})()},[s]),te.useEffect(()=>{const A=S=>{d&&(S.key==="Escape"?m(!1):S.key==="ArrowLeft"?T():S.key==="ArrowRight"&&M())};return document.addEventListener("keydown",A),()=>document.removeEventListener("keydown",A)},[d,p]),te.useEffect(()=>(d?document.body.style.overflow="hidden":document.body.style.overflow="unset",()=>{document.body.style.overflow="unset"}),[d]);const _=A=>{g(A),m(!0)},x=()=>{m(!1)},M=()=>{e?.images&&g(A=>A===e.images.length-1?0:A+1)},T=()=>{e?.images&&g(A=>A===0?e.images.length-1:A-1)};return r?C.jsx("p",{className:"text-center py-10 text-white/70",children:"Loading project…"}):c?C.jsx("p",{className:"text-center py-10 text-red-400",children:c}):e?C.jsxs(C.Fragment,{children:[C.jsxs("section",{className:"max-w-5xl mx-auto px-4 pt-10",children:[C.jsx("h1",{className:"text-3xl font-bold mb-4",children:e.title}),e.category&&C.jsx("p",{className:"text-white/60 mb-6",children:e.category}),e.description&&C.jsx("p",{className:"mb-6 leading-relaxed",children:e.description}),e.images?.[0]&&C.jsx("img",{src:e.images[0].path,alt:e.title,className:"w-full rounded-2xl shadow mb-6 cursor-pointer hover:opacity-90 transition-opacity",onClick:()=>_(0)}),e.images&&e.images.length>1&&C.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 gap-4",children:e.images.slice(1).map((A,S)=>C.jsx("img",{src:A.path,alt:`${e.title}-${S+2}`,className:"w-full h-48 object-cover rounded-xl border border-white/10 cursor-pointer hover:opacity-90 hover:scale-105 transition-all duration-300",onClick:()=>_(S+1)},S))})]}),d&&e.images&&C.jsxs("div",{className:"fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4",onClick:x,children:[C.jsx("button",{onClick:x,className:"absolute top-4 right-4 text-white/70 hover:text-white text-3xl z-10 p-2 rounded-full hover:bg-white/10 transition","aria-label":"Close lightbox",children:"✕"}),C.jsxs("div",{className:"absolute top-4 left-4 text-white/70 text-sm z-10",children:[p+1," / ",e.images.length]}),e.images.length>1&&C.jsx("button",{onClick:A=>{A.stopPropagation(),T()},className:"absolute left-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white text-4xl p-3 rounded-full hover:bg-white/10 transition z-10","aria-label":"Previous image",children:"‹"}),e.images.length>1&&C.jsx("button",{onClick:A=>{A.stopPropagation(),M()},className:"absolute right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white text-4xl p-3 rounded-full hover:bg-white/10 transition z-10","aria-label":"Next image",children:"›"}),C.jsx("img",{src:e.images[p].path,alt:`${e.title}-${p+1}`,className:"max-w-full max-h-full object-contain rounded-lg shadow-2xl",onClick:A=>A.stopPropagation()}),C.jsxs("div",{className:"absolute bottom-4 left-1/2 -translate-x-1/2 text-white/50 text-sm text-center",children:[C.jsx("p",{className:"hidden md:block",children:"Use arrow keys or click buttons to navigate • ESC to close"}),C.jsx("p",{className:"md:hidden",children:"Tap arrows to navigate • Tap outside to close"})]})]})]}):C.jsx("p",{className:"text-center py-10 text-white/60",children:"Project not found."})}function kR(){const[s,e]=te.useState({username:"",password:""}),[i,r]=te.useState(!1),[l,c]=te.useState(""),f=Ih(),d=p=>{e({...s,[p.target.name]:p.target.value})},m=async p=>{p.preventDefault(),r(!0),c("");try{const g=await fetch("https://interior-portfolio-api.onrender.com/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:s.username,password:s.password})}),_=await g.json();if(!g.ok)throw new Error(_.error||"Login failed");localStorage.setItem("adminToken",_.token),f("/admin/dashboard")}catch(g){c(g.message)}finally{r(!1)}};return C.jsx("div",{className:"min-h-screen flex items-center justify-center bg-luxuryBg px-4",children:C.jsx("div",{className:"max-w-md w-full",children:C.jsxs("div",{className:"rounded-2xl p-8 bg-luxurySurface border border-white/10",children:[C.jsxs("div",{className:"text-center mb-8",children:[C.jsx("h1",{className:"font-display text-3xl text-white mb-2",children:"Admin Login"}),C.jsx("p",{className:"text-luxuryMuted",children:"Access your portfolio dashboard"})]}),l&&C.jsx("div",{className:"mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20",children:C.jsx("p",{className:"text-red-400 text-sm",children:l})}),C.jsxs("form",{onSubmit:m,className:"space-y-6",children:[C.jsxs("div",{children:[C.jsx("label",{className:"block text-sm font-medium text-white mb-2",children:"Username"}),C.jsx("input",{type:"text",name:"username",value:s.username,onChange:d,required:!0,className:"w-full px-4 py-3 rounded-lg bg-luxuryBg border border-white/10 text-white placeholder-luxuryMuted focus:border-luxuryGold focus:outline-none transition",placeholder:"Enter your username"})]}),C.jsxs("div",{children:[C.jsx("label",{className:"block text-sm font-medium text-white mb-2",children:"Password"}),C.jsx("input",{type:"password",name:"password",value:s.password,onChange:d,required:!0,className:"w-full px-4 py-3 rounded-lg bg-luxuryBg border border-white/10 text-white placeholder-luxuryMuted focus:border-luxuryGold focus:outline-none transition",placeholder:"Enter your password"})]}),C.jsx("button",{type:"submit",disabled:i,className:"w-full py-3 px-4 rounded-lg bg-luxuryGold text-black font-medium hover:bg-luxuryGold/90 focus:outline-none focus:ring-2 focus:ring-luxuryGold/50 transition disabled:opacity-50 disabled:cursor-not-allowed",children:i?"Signing in...":"Sign In"})]}),C.jsx("div",{className:"mt-6 pt-6 border-t border-white/10",children:C.jsx("p",{className:"text-xs text-luxuryMuted text-center",children:"This is a secure admin area. Only authorized users can access."})})]})})})}function jR(){if(!localStorage.getItem("adminToken"))return window.location.href="/admin",null;const[e,i]=te.useState(!1),r=b=>b?b.startsWith("http")?b:`https://interior-portfolio-api.onrender.com${b}`:null,[l,c]=te.useState("home"),[f,d]=te.useState([]),[m,p]=te.useState({id:null,name:"",cover:null,existingCover:null}),[g,_]=te.useState([]),[x,M]=te.useState({id:null,title:"",description:"",category_id:"",images:[],existingImages:[]}),T=async()=>{try{const Y=(await(await fetch("https://interior-portfolio-api.onrender.com/api/categories")).json()).map(oe=>({...oe,cover_image:oe.cover_image?oe.cover_image:null}));d(Y)}catch(b){console.error("fetchCategories err",b)}},A=async()=>{try{const Y=(await(await fetch("https://interior-portfolio-api.onrender.com/api/projects")).json()).map(oe=>{const pe=Array.isArray(oe.images)?oe.images.map(ce=>{if(!ce)return null;if(typeof ce=="string")return{id:null,path:r(ce)};{const I=ce.id??ce.image_id??null,Q=ce.path??ce.image_path??null;return{id:I,path:r(Q)}}}).filter(Boolean):[];return{...oe,images:pe}});_(Y)}catch(b){console.error("fetchProjects err",b)}};te.useEffect(()=>{T(),A()},[]);const S=async b=>{b.preventDefault(),i(!0);try{const B=new FormData;B.append("name",m.name),m.cover&&B.append("cover",m.cover);const Y=m.id?`https://interior-portfolio-api.onrender.com/api/categories/${m.id}`:"https://interior-portfolio-api.onrender.com/api/categories",oe=m.id?"PUT":"POST",pe=await fetch(Y,{method:oe,body:B});if(!pe.ok){const ce=await pe.json().catch(()=>({error:"failed"}));throw new Error(ce.error||"Failed to save category")}p({id:null,name:"",cover:null,existingCover:null}),await T(),alert("Category saved")}catch(B){console.error(B),alert(B.message||"Failed to save category")}finally{i(!1)}},v=b=>{p({id:b.id,name:b.name,cover:null,existingCover:b.cover_image?b.cover_image:null}),c("categories")},L=async b=>{if(window.confirm("Delete this category?")){i(!0);try{await fetch(`https://interior-portfolio-api.onrender.com/api/categories/${b}`,{method:"DELETE"}),await T()}catch(B){console.error(B),alert("Failed to delete category")}finally{i(!1)}}},P=async b=>{b.preventDefault(),i(!0);try{const B=new FormData;B.append("title",x.title),B.append("description",x.description),B.append("category_id",x.category_id),x.existingImages&&x.existingImages.length>0&&x.existingImages.forEach(ce=>{ce.id&&B.append("existingImages",ce.id)}),x.images&&x.images.length>0&&Array.from(x.images).forEach(ce=>B.append("images",ce));const Y=x.id?`https://interior-portfolio-api.onrender.com/api/projects/${x.id}`:"https://interior-portfolio-api.onrender.com/api/projects",oe=x.id?"PUT":"POST",pe=await fetch(Y,{method:oe,body:B});if(!pe.ok){const ce=await pe.json().catch(()=>({error:"failed"}));throw new Error(ce.error||"Failed to save project")}M({id:null,title:"",description:"",category_id:"",images:[],existingImages:[]}),await A(),alert("Project saved")}catch(B){console.error(B),alert(B.message||"Failed to save project")}finally{i(!1)}},N=b=>{const B=Array.isArray(b.images)?b.images.map(Y=>({id:Y.id??null,path:Y.path??r(Y.path)})):[];M({id:b.id,title:b.title||"",description:b.description||"",category_id:b.category_id||"",images:[],existingImages:B}),c("projects"),window.scrollTo({top:0,behavior:"smooth"})},F=async b=>{if(window.confirm("Delete this project?")){i(!0);try{await fetch(`https://interior-portfolio-api.onrender.com/api/projects/${b}`,{method:"DELETE"}),await A()}catch(B){console.error(B),alert("Failed to delete project")}finally{i(!1)}}},V=async(b,B=x.id)=>{if(window.confirm("Delete this image?")){i(!0);try{if(b.id&&!(await fetch(`https://interior-portfolio-api.onrender.com/api/projects/image/${b.id}`,{method:"DELETE"})).ok)throw new Error("Server failed to delete image");M(Y=>({...Y,existingImages:Y.existingImages.filter(oe=>oe.id&&b.id?oe.id!==b.id:oe.path!==b.path)})),_(Y=>Y.map(oe=>oe.id!==B?oe:{...oe,images:(oe.images||[]).filter(pe=>pe?typeof pe=="string"?r(pe)!==r(b.path):typeof pe=="object"?(pe.id??null)!==(b.id??null):!0:!1)}))}catch(Y){console.error("removeExistingProjectImage error:",Y),alert("Failed to delete image")}finally{i(!1)}}},G=b=>{const B=b.target.files?.[0]??null;p(Y=>({...Y,cover:B}))},K=b=>{const B=b.target.files?Array.from(b.target.files):[];M(Y=>({...Y,images:B}))},D=b=>{if(!b||!b.images||b.images.length===0)return null;const B=b.images[0];return B?typeof B=="string"?r(B):typeof B=="object"?B.path??r(B):null:null};return C.jsxs("div",{className:"flex min-h-screen bg-luxuryBg text-white",children:[C.jsxs("aside",{className:"w-60 bg-luxurySurface p-6 flex flex-col gap-4",children:[C.jsx("button",{onClick:()=>c("home"),className:`py-2 px-4 rounded-lg ${l==="home"?"bg-luxuryGold text-black":""}`,children:"Home"}),C.jsx("button",{onClick:()=>c("categories"),className:`py-2 px-4 rounded-lg ${l==="categories"?"bg-luxuryGold text-black":""}`,children:"Categories"}),C.jsx("button",{onClick:()=>c("projects"),className:`py-2 px-4 rounded-lg ${l==="projects"?"bg-luxuryGold text-black":""}`,children:"Projects"})]}),C.jsxs("main",{className:"flex-1 p-8 overflow-auto",children:[l==="home"&&C.jsxs("div",{className:"text-center mt-20",children:[C.jsx("h1",{className:"text-4xl font-bold mb-4",children:"Welcome Admin!"}),C.jsx("p",{className:"text-lg text-white/70",children:"Use the buttons on the left to manage Categories and Projects."})]}),l==="categories"&&C.jsxs("div",{children:[C.jsx("h2",{className:"text-2xl font-bold mb-4",children:"Categories"}),C.jsxs("form",{onSubmit:S,className:"mb-6 flex flex-col gap-3",children:[C.jsx("input",{type:"text",value:m.name,onChange:b=>p({...m,name:b.target.value}),placeholder:"Category Name",className:"px-4 py-2 rounded-lg bg-luxuryBg border border-white/10 text-white"}),m.existingCover&&!m.cover&&C.jsx("img",{src:r(m.existingCover),alt:"cover",className:"w-48 h-32 object-cover rounded-lg"}),C.jsx("input",{type:"file",accept:"image/*",onChange:G,className:"text-white"}),m.cover&&C.jsx("img",{src:URL.createObjectURL(m.cover),alt:"preview",className:"w-48 h-32 object-cover rounded-lg"}),C.jsx("button",{className:"bg-luxuryGold text-black px-4 py-2 rounded-lg",children:m.id?"Save Category":"Add Category"})]}),C.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:f.map(b=>C.jsxs("div",{className:"relative rounded-2xl overflow-hidden border border-white/10 bg-white/5",children:[b.cover_image&&C.jsx("img",{src:r(b.cover_image),alt:b.name,className:"w-full h-32 object-cover"}),C.jsxs("div",{className:"p-4 flex justify-between items-center",children:[C.jsx("span",{children:b.name}),C.jsxs("div",{className:"flex gap-2",children:[C.jsx("button",{onClick:()=>v(b),className:"bg-blue-600 px-2 py-1 rounded-lg text-sm",children:"Edit"}),C.jsx("button",{onClick:()=>L(b.id),className:"bg-red-600 px-2 py-1 rounded-lg text-sm",children:"Delete"})]})]})]},b.id))})]}),l==="projects"&&C.jsxs("div",{children:[C.jsx("h2",{className:"text-2xl font-bold mb-4",children:"Projects"}),C.jsxs("form",{onSubmit:P,className:"mb-6 flex flex-col gap-3",children:[C.jsx("input",{type:"text",value:x.title,onChange:b=>M({...x,title:b.target.value}),placeholder:"Project Title",className:"px-4 py-2 rounded-lg bg-luxuryBg border border-white/10 text-white"}),C.jsx("textarea",{value:x.description,onChange:b=>M({...x,description:b.target.value}),placeholder:"Project Description",className:"px-4 py-2 rounded-lg bg-luxuryBg border border-white/10 text-white"}),C.jsxs("select",{value:x.category_id,onChange:b=>M({...x,category_id:b.target.value}),className:"px-4 py-2 rounded-lg bg-luxuryBg border border-white/10 text-white",children:[C.jsx("option",{value:"",children:"Select Category"}),f.map(b=>C.jsx("option",{value:b.id,children:b.name},b.id))]}),x.existingImages.length>0&&C.jsx("div",{className:"flex gap-2 mb-2 flex-wrap",children:x.existingImages.map(b=>C.jsxs("div",{className:"relative",children:[C.jsx("img",{src:b.path,alt:"project",className:"w-20 h-20 object-cover rounded-lg"}),C.jsx("button",{type:"button",onClick:()=>V(b),className:"absolute top-0 right-0 bg-red-600 text-white rounded-full w-5 h-5 text-xs",children:"×"})]},b.id??b.path))}),C.jsx("input",{type:"file",accept:"image/*",multiple:!0,onChange:K,className:"text-white"}),x.images&&x.images.length>0&&C.jsx("div",{className:"flex gap-2 mt-2 flex-wrap",children:Array.from(x.images).map((b,B)=>C.jsx("img",{src:URL.createObjectURL(b),alt:`new-${B}`,className:"w-20 h-20 object-cover rounded-lg"},B))}),C.jsx("button",{className:"bg-luxuryGold text-black px-4 py-2 rounded-lg",children:x.id?"Save Project":"Add Project"})]}),C.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:g.map(b=>C.jsxs("div",{className:"rounded-2xl overflow-hidden border border-white/10 bg-white/5",children:[D(b)&&C.jsx("img",{src:D(b),alt:b.title,className:"w-full h-48 object-cover"}),C.jsxs("div",{className:"p-4 flex justify-between items-center",children:[C.jsxs("div",{children:[C.jsx("h3",{children:b.title}),C.jsx("p",{className:"text-white/60",children:b.description})]}),C.jsxs("div",{className:"flex gap-2",children:[C.jsx("button",{onClick:()=>N(b),className:"bg-blue-600 px-2 py-1 rounded-lg text-sm",children:"Edit"}),C.jsx("button",{onClick:()=>F(b.id),className:"bg-red-600 px-2 py-1 rounded-lg text-sm",children:"Delete"})]})]})]},b.id))})]})]}),e&&C.jsxs("div",{className:"fixed inset-0 bg-black/70 flex items-center justify-center z-50",children:[C.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-t-4 border-luxuryGold border-solid"}),C.jsx("span",{className:"ml-4 text-luxuryGold text-xl font-semibold",children:"Processing..."})]})]})}function XR(){const[s,e]=te.useState(!1),i=fa(),r=Ih(),l=d=>{const m=document.getElementById(d);if(!m)return!1;const p=document.querySelector("header"),x=-((p?p.offsetHeight:64)+20),M=m.getBoundingClientRect().top+window.pageYOffset+x;return window.scrollTo({top:M,behavior:"smooth"}),!0},c=d=>{if(e(!1),i.pathname==="/"){l(d);return}r("/",{state:{scrollTo:d}})},f=()=>{e(!1),i.pathname==="/"?window.scrollTo({top:0,behavior:"smooth"}):r("/")};return C.jsxs("header",{className:"sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-purple-300/20",children:[C.jsxs("div",{className:"max-w-6xl mx-auto px-4 h-16 flex items-center justify-between",children:[C.jsxs("button",{onClick:f,className:"font-display text-xl tracking-wide text-left group","aria-label":"Go to home",children:[C.jsx("span",{className:"text-purple-400 group-hover:text-pink-400 transition-colors duration-300",children:"A."}),C.jsx("span",{className:"text-white group-hover:text-purple-200 transition-colors duration-300",children:"Interiors"})]}),C.jsxs("nav",{className:"hidden md:flex gap-6 text-sm items-center",children:[C.jsx("button",{onClick:f,className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Home"}),C.jsx("button",{onClick:()=>c("categories"),className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Categories"}),C.jsx(kd,{to:"/projects",className:({isActive:d})=>d?"text-purple-400 relative after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-px after:bg-gradient-to-r after:from-purple-400 after:to-pink-400":"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Projects"}),C.jsx("button",{onClick:()=>c("about"),className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"About"}),C.jsx("button",{onClick:()=>c("contact"),className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Contact"})]}),C.jsx("a",{href:"/cv.pdf",className:"hidden md:inline text-sm border border-purple-300/30 hover:border-purple-400/60 px-3 py-1.5 rounded-sm text-purple-200 hover:text-white hover:bg-purple-400/10 transition-all duration-300",download:!0,children:"Download CV"}),C.jsx("button",{className:"md:hidden text-2xl text-purple-300 hover:text-pink-400 transition-colors duration-300",onClick:()=>e(d=>!d),"aria-label":"Toggle menu",children:s?"✖":"☰"})]}),C.jsx("div",{className:`md:hidden overflow-hidden transition-all duration-400 ease-in-out ${s?"max-h-[500px] opacity-100":"max-h-0 opacity-0"} bg-slate-950/95 backdrop-blur-md border-t border-purple-300/20`,children:C.jsxs("nav",{className:"flex flex-col items-center py-4 gap-4",children:[C.jsx("button",{onClick:()=>{e(!1),f()},className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Home"}),C.jsx(kd,{to:"/projects",className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",onClick:()=>e(!1),children:"Projects"}),C.jsx("button",{onClick:()=>c("categories"),className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Categories"}),C.jsx("button",{onClick:()=>c("about"),className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"About"}),C.jsx("button",{onClick:()=>c("contact"),className:"text-gray-300 hover:text-purple-300 transition-colors duration-300",children:"Contact"}),C.jsx("a",{href:"/cv.pdf",className:"text-sm border border-purple-300/30 hover:border-purple-400/60 px-3 py-1.5 rounded-sm text-purple-200 hover:text-white hover:bg-purple-400/10 transition-all duration-500",download:!0,onClick:()=>e(!1),children:"Download CV"})]})})]})}function WR(){return C.jsx("footer",{className:"border-t border-white/5 mt-12",children:C.jsxs("div",{className:"max-w-6xl mx-auto px-4 py-8 text-sm text-luxuryMuted flex flex-col md:flex-row gap-2 justify-between",children:[C.jsxs("p",{children:["© ",new Date().getFullYear()," A. Interiors — All rights reserved."]}),C.jsx("p",{children:"DevSam."})]})})}function qR(){return C.jsxs("div",{className:"min-h-screen bg-luxuryBg text-white flex flex-col",children:[C.jsx(XR,{}),C.jsx("main",{className:"flex-1",children:C.jsxs(HS,{children:[C.jsx(vr,{path:"/",element:C.jsx(FR,{})}),C.jsx(vr,{path:"/category/:categoryId",element:C.jsx(zR,{})}),C.jsx(vr,{path:"/projects",element:C.jsx(GR,{})}),C.jsx(vr,{path:"/projects/:id",element:C.jsx(VR,{})}),C.jsx(vr,{path:"/admin",element:C.jsx(kR,{})}),C.jsx(vr,{path:"/admin/dashboard",element:C.jsx(jR,{})})]})}),C.jsx(WR,{})]})}Ky.createRoot(document.getElementById("root")).render(C.jsx(Vy.StrictMode,{children:C.jsx(cM,{children:C.jsx(qR,{})})}));
